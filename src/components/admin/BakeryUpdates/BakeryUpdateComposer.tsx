...
type StoredDraft = BakeryUpdateDraft & { requestKey: string }
...
export const BakeryUpdateComposer: React.FC<BakeryUpdateComposerProps> = ({
  ...
  const updateDraft = (changes: Partial<BakeryUpdateDraft>) =>
          ...
          <form className={styles.form} onSubmit={handleSubmit}>
            ...
            {draft.sendEmail ? (
              <div className={styles.field}>
                ...
                <input
                  ...
                  placeholder="Lemon cookies are back this Saturday"
                  type="text"
                  value={draft.subject}
                />
              </div>
            ...
            <div className={styles.field}>
              ...
              <textarea
                ...
                placeholder="New flavor this week, and we will be at the farmers market Saturday 9 to 1."
                rows={7}
                value={draft.message}
              />
              <p className={styles.helper}>
