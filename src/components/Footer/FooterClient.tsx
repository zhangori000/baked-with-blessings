...
export function FooterClient({ brand, copyrightName, currentYear, navItems }: FooterClientProps) {
  ...
  return (
    <SceneSurface
      as="footer"
      className="relative flex min-h-[34rem] flex-col overflow-hidden sm:min-h-[32rem] md:min-h-[29rem]"
      variant="footer"
    >
      <CartSceneShell
        className="flex w-full flex-1 flex-col !overflow-hidden"
        contentClassName="relative z-[1] flex min-h-full flex-1 flex-col"
        hideCompactFlowers
        hideSheep
        variant="compact"
      >
        <div className="relative z-[1] mx-auto grid min-h-full w-full max-w-[1320px] flex-1 box-border content-stretch px-4 pb-5 pt-4 sm:px-5 sm:pb-6 sm:pt-5 md:px-6 md:pb-7 md:pt-6">
          <BakeryCard
