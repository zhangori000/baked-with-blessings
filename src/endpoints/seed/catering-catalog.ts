...
export const cateringCatalog: CateringSeedSpec[] = [
  {
    ...
    menuPortionLabel: '10 jumbo cookies · one flavor',
    metaDescription: 'A catering tray of ten jumbo cookies, all one flavor — including rare flavors not on the regular menu.',
    priceInUSD: 5000,
