...
Instructions for AI coding agents (Codex, Cursor, etc.) when working on Payload CMS projects.
...
- `ai-instructions/learnings/pr/2026-04-16/pr-image-enhancements.md`
- `ai-instructions/learnings/pr/2026-04-16/pr-seed-refactor.md`

The date folder should map 1:1 to the day the note was created. Use descriptive filenames that start with `pr-`.
...
export const myPlugin =
  (
    pluginOptions: MyPluginConfig, // stage 1: developer calls this
  ) =>
...
The developer has their plugin options. Payload has the full app config. They're available at different times — currying lets each party contribute at the right moment.
